...
<head>
    ...
    <style>
        ...
        * {
        ...
        .menu-item-url-group:focus-within {
            border-color: #6366f1;
            background: white;
        }
...
<body>
            ...
            <div class="page-container">
                ...
                <form method="POST" id="settingsForm" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-grid">
                                    ...
                                    <div class="form-group full-width">
                                        ...
                                        <div class="logo-upload-group"><img src="<?= htmlspecialchars($settings['site_logo']) ?>" alt="Logo" class="logo-preview" id="logoPreview" onerror="this.src='assets/default-logo.png'">
                    ...
                    <div class="tab-content" id="tab-menu">
                        <div class="card">
                            <div class="card-header">
                                <div class="icon-box blue"><i class="fas fa-edit"></i></div>
                ...
                <div class="tab-content" id="tab-system">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" id="importForm"><input type="hidden" name="csrf_token" value="<?= $csrf_token ?>"><input type="hidden" name="action" value="import_sample_data"><button type="button" class="btn btn-primary" onclick="confirmImport()"><i class="fas fa-download"></i> นำเข้าเลย</button></form>
                        </div>
                    </div>
    ...
    <script>
        ...
        function toggleMenuRow(cb) {
            ...
            if (cb.checked) row.classList.remove('hidden-menu');
        ...
        function confirmClear(type) {
            const c = {
                risks: ['ล้างความเสี่ยง', false],
                reports: ['ล้างรายงาน', false],
                all_except_users: ['ล้างทุกตาราง (ยกเว้นผู้ใช้)', false],
                users_except_admin: ['ล้างผู้ใช้', true]
            };
            Swal.fire({
                    title: c[type][0] + '?',
                    icon: 'warning',
                    ...
                    if (r.isConfirmed) {
                        if (c[type][1]) {
                            Swal.fire({
                                ...
                                if (r2.isConfirmed) submitClear(type);
                            });
        ...
        <?php if ($success_message): ?>Swal.fire({
            icon: 'success',
            title: 'สำเร็จ!',
        ...
        <?php endif; ?>
        <?php if ($error_message): ?>Swal.fire({
            icon: 'error',
            title: 'ผิดพลาด!',
